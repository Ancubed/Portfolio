        ...
        item ? (
          <animated.div
            ...
            className={classnames(
              className,
              "flex flex-col items-center w-full -translate-y-2/4 top-1/2 sm:max-w-md sm:left-1/2 sm:-translate-x-2/4 lg:left-1/2 lg:-translate-x-2/4"
            )}
          >
            {enLang
              ? "I will write to you soon"
              : "Я напишу Вам в ближайшее время"}
          </animated.div>
        ) : (
          <animated.form
            style={style}
